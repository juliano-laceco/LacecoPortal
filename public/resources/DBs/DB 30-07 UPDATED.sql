...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `CopyProjectToVersion`(IN input_project_id INT, IN version_num INT)
BEGIN
    ...
    DECLARE current_isBaselined TINYINT;
    ...
    INSERT INTO project_versions (
        ...
        end_date, variance, employee_id, project_status, intial_project_id, version, created_on, created_by
    ) VALUES (
        current_title, current_code, current_geography, current_city, current_client_id, 
        current_typology, current_sector, current_intervention, current_baseline_budget, 
        current_BUA, current_Landscape, current_ParkingArea, current_DesignArea, 
        ...
        input_project_id, version_num, DATE_FORMAT(current_created_on, '%Y-%m-%d'), current_created_by
    );
    
    CALL InsertPhasesIntoPhaseVersions(input_project_id, 1);
END ;;
DELIMITER ;
...
BEGIN
    ...
    read_loop: LOOP
        ...
        INSERT INTO phase_assignee_versions (
            assignee_id, work_done_hrs, expected_work_hrs, phase_id
        ) VALUES (
            current_assignee_id, current_work_done_hrs, current_expected_work_hrs, 
            new_phase_version_id
        );
...
BEGIN
    ...
    read_loop: LOOP
        ...
        CALL InsertPhaseAssigneesIntoPhaseAssigneeVersions(current_phase_id, new_phase_version_id);
...
-- Dump completed on 2024-07-31  9:56:24
