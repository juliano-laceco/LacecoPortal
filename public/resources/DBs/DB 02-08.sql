...
INSERT INTO `phase` VALUES (13,'Master Plan','2025-04-03','2026-04-03',NULL,NULL,'Pending',0,0,20,'2024-06-07 16:13:29',1),(32,'Pre-Conceptual Design','2025-04-03','2026-04-03',NULL,NULL,'Pending',0,0,20,'2024-06-10 14:56:49',1),(107,'Conceptual Design','2025-04-03','2026-04-03',NULL,NULL,'Pending',0,0,20,'2024-07-26 11:24:25',1),(116,'Schematic Design','2025-04-03','2026-04-03',NULL,NULL,'Pending',0,0,20,'2024-07-29 12:37:20',1),(121,'Hydrology Coordination','2025-03-04','2026-03-04',NULL,NULL,'Pending',214,0,28,'2024-07-30 13:27:15',1),(122,'Master Plan','2025-03-04','2026-03-04',NULL,NULL,'Pending',332,0,28,'2024-07-30 13:27:15',1),(123,'100% DD','2025-03-04','2026-03-04',NULL,NULL,'Pending',512,0,28,'2024-07-30 13:27:15',1),(126,'Master Plan','2025-03-04','2026-03-04',NULL,NULL,'Pending',0,0,25,'2024-07-30 16:25:20',1),(127,'Master Plan','2025-03-04','2026-03-04',NULL,NULL,'Pending',0,0,27,'2024-07-30 16:25:32',1),(128,'TD','2025-03-04','2026-03-04',NULL,NULL,'Pending',0,0,28,'2024-07-30 16:26:43',1),(129,'Building Permit','2025-03-04','2026-03-04',NULL,NULL,'Pending',78,0,31,'2024-08-01 22:31:13',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=1856 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `phase_assignee_versions` VALUES (1854,373,0,39,410,1),(1855,365,0,39,410,1);
...
INSERT INTO `phase_versions` VALUES (410,'Building Permit','2025-03-04','2026-03-04',NULL,NULL,'Pending',78,0,129,1,'2024-08-01',1);
...
INSERT INTO `project_disciplines_versions` VALUES (936,83,60,1),(937,83,62,1),(938,83,66,1),(939,83,80,1),(940,83,78,1);
...
INSERT INTO `project_versions` VALUES (83,'BASELINE_TEST','BASELINE_TEST_961_2024','Lebanon','Beirut',6,'Residential','Private','Masterplanning',180000,180000,180000,180000,18000,'2025-03-04','2026-03-04',NULL,NULL,0,1,'Highly Probable',31,1,'2024-08-01',1);
...
INSERT INTO `projected_work_week_versions` VALUES (5928,1854,'2024-07-01',12,1),(5929,1854,'2024-07-08',12,1),(5930,1854,'2024-07-15',15,1),(5931,1855,'2024-07-01',12,1),(5932,1855,'2024-07-08',12,1),(5933,1855,'2024-07-15',15,1);
...
BEGIN
    ...
    DECLARE phase_cursor CURSOR FOR
        SELECT 
            ...
            end_date, phase_status, actioned_on, actioned_by , expected_work_hours , completed_work_hours
        FROM 
            phase
        WHERE 
            project_id = input_project_id;
    ...
    read_loop: LOOP
        FETCH phase_cursor INTO 
            ...
            current_start_date, current_end_date, current_phase_status, current_actioned_on, current_actioned_by , current_expected_work_hours , current_completed_work_hours ;
...
-- Dump completed on 2024-08-02 14:36:45
