...
INSERT INTO `phase` VALUES (13,'Master Plan','2025-04-03','2026-04-03',NULL,NULL,'Pending',0,0,20,'2024-06-07 16:13:29',1),(32,'Pre-Conceptual Design','2025-04-03','2026-04-03',NULL,NULL,'Pending',0,0,20,'2024-06-10 14:56:49',1),(107,'Conceptual Design','2025-04-03','2026-04-03',NULL,NULL,'Pending',0,0,20,'2024-07-26 11:24:25',1),(116,'Schematic Design','2025-04-03','2026-04-03',NULL,NULL,'Pending',0,0,20,'2024-07-29 12:37:20',1),(121,'Hydrology Coordination','2025-03-04','2026-03-04',NULL,NULL,'Pending',0,0,28,'2024-07-30 13:27:15',1),(122,'Master Plan','2025-03-04','2026-03-04',NULL,NULL,'Pending',0,0,28,'2024-07-30 13:27:15',1),(123,'100% DD','2025-03-04','2026-03-04',NULL,NULL,'Pending',0,0,28,'2024-07-30 13:27:15',1),(126,'Master Plan','2025-03-04','2026-03-04',NULL,NULL,'Pending',0,0,25,'2024-07-30 16:25:20',1),(127,'Master Plan','2025-03-04','2026-03-04',NULL,NULL,'Pending',246,0,27,'2024-07-30 16:25:32',1),(128,'TD','2025-03-04','2026-03-04',NULL,NULL,'Pending',0,0,28,'2024-07-30 16:26:43',1);
...
INSERT INTO `phase_assignee` VALUES (19,385,0,0,121),(20,343,0,0,121),(21,318,0,0,121),(22,385,0,0,122),(23,343,0,0,122),(24,434,0,0,122),(25,378,0,0,122),(26,366,0,0,122),(27,308,0,0,122),(28,323,0,0,122),(29,342,0,0,122),(30,332,0,0,122),(31,405,0,0,122),(32,295,0,0,122),(33,304,0,0,122),(34,374,0,0,122),(35,385,0,0,123),(36,318,0,0,122),(37,436,0,0,122),(38,343,0,0,123),(39,378,0,0,123),(40,366,0,0,123),(41,387,0,0,123),(42,308,0,0,123),(43,323,0,0,123),(44,342,0,0,123),(45,332,0,0,123),(46,428,0,0,123),(52,428,0,0,123),(54,405,0,246,127);
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_insert_phase_assignee` AFTER INSERT ON `phase_assignee` FOR EACH ROW BEGIN
    DECLARE affected_phase_id INT;
    SET affected_phase_id = NEW.phase_id;

    -- Update expected_work_hours for the affected phase_id
    UPDATE phase
    SET expected_work_hours = (
        SELECT IFNULL(SUM(expected_work_hrs), 0)
        FROM phase_assignee
        WHERE phase_id = affected_phase_id
    )
    WHERE phase_id = affected_phase_id;
END */;;
DELIMITER ;
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_delete_phase_assignee` AFTER DELETE ON `phase_assignee` FOR EACH ROW BEGIN
    DECLARE affected_phase_id INT;
    SET affected_phase_id = OLD.phase_id;
...
INSERT INTO `phase_assignee_versions` VALUES (1654,385,0,0,380,1),(1655,343,0,0,380,1),(1656,318,0,0,380,1),(1657,385,0,0,381,1),(1658,343,0,0,381,1),(1659,434,0,0,381,1),(1660,378,0,0,381,1),(1661,366,0,0,381,1),(1662,308,0,0,381,1),(1663,323,0,0,381,1),(1664,342,0,0,381,1),(1665,332,0,0,381,1),(1666,405,0,0,381,1),(1667,295,0,0,381,1),(1668,304,0,0,381,1),(1669,374,0,0,381,1),(1670,318,0,0,381,1),(1671,436,0,0,381,1),(1672,385,0,0,382,1),(1673,343,0,0,382,1),(1674,378,0,0,382,1),(1675,366,0,0,382,1),(1676,387,0,0,382,1),(1677,308,0,0,382,1),(1678,323,0,0,382,1),(1679,342,0,0,382,1),(1680,332,0,0,382,1),(1681,428,0,0,382,1);
...
INSERT INTO `phase_versions` VALUES (380,'Hydrology Coordination','2025-03-04','2026-03-04',NULL,NULL,'Pending',0,0,121,1,'2024-07-30',1),(381,'Master Plan','2025-03-04','2026-03-04',NULL,NULL,'Pending',0,0,122,1,'2024-07-30',1),(382,'100% DD','2025-03-04','2026-03-04',NULL,NULL,'Pending',0,0,123,1,'2024-07-30',1),(383,'TD','2025-03-04','2026-03-04',NULL,NULL,'Pending',0,0,128,1,'2024-07-30',1);
...
INSERT INTO `project_disciplines_versions` VALUES (856,68,80,1),(857,68,83,1),(858,68,67,1),(859,68,63,1),(860,68,68,1),(861,68,66,1),(862,68,61,1),(863,68,64,1),(864,68,69,1),(865,68,78,1);
...
INSERT INTO `project_versions` VALUES (68,'NOMAD-KL','NOMAD_KL_961_2024','Saudi Arabia','Riyadh',7,'Residential','Private','Masterplanning',1752,12000,9000,6000,18000,'2023-12-11','2024-09-11',NULL,NULL,0,385,'Highly Probable',28,1,'2024-07-30',1);
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_insert_projected_work_week` AFTER INSERT ON `projected_work_week` FOR EACH ROW BEGIN
    DECLARE affected_phase_assignee_id INT;
    SET affected_phase_assignee_id = NEW.phase_assignee_id;

    -- Update expected_work_hrs for the affected phase_assignee_id
    UPDATE phase_assignee
    SET expected_work_hrs = (
        SELECT IFNULL(SUM(hours_expected), 0)
        FROM projected_work_week
        WHERE phase_assignee_id = affected_phase_assignee_id
    )
    WHERE phase_assignee_id = affected_phase_assignee_id;
END */;;
DELIMITER ;
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_delete_projected_work_week` AFTER DELETE ON `projected_work_week` FOR EACH ROW BEGIN
    DECLARE affected_phase_assignee_id INT;
    SET affected_phase_assignee_id = OLD.phase_assignee_id;
...
) ENGINE=InnoDB AUTO_INCREMENT=5360 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
BEGIN
	...
	DECLARE current_phase_expected_work_hours INT;
    DECLARE current_phase_completed_work_hours INT;
    ...
    read_loop: LOOP
        FETCH phase_cursor INTO 
            ...
            current_start_date, current_end_date, current_phase_status, current_phase_expected_work_hours, current_phase_completed_work_hours , current_actioned_on, current_actioned_by;
        ...
        INSERT INTO phase_versions (
            ...
            end_date, phase_status, initial_phase_id, actioned_on, actioned_by, version , expected_work_hours , completed_work_hours 
        ) VALUES (
            ...
            DATE_FORMAT(current_actioned_on, '%Y-%m-%d'), current_actioned_by, version_num, current_phase_expected_work_hours , current_phase_completed_work_hours
        );
...
-- Dump completed on 2024-08-01 12:37:02
