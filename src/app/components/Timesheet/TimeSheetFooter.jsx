function TimeSheetFooter({ weekDays, calculateTotalHours, calculateTotalWeekHours }) {
    return (
        <div className="flex bg-gray-100 font-bold bg-gray-300 mob:flex-col tablet:flex-col w-full desk:bg-pric lap:bg-pric desk:text-white lap:text-white">
            <div className="p-4 border-t flex justify-center items-center desk:min-w-44 desk:max-w-44 lap:min-w-36 lap:max-w-36 mob:hidden tablet:hidden">Total (hrs)</div>
